...
def page0():
    ...
    turtle.goto(-350, 0)
    turtle.color('black')
    turtle.write('给春儿的第一份礼物', font=('宋体', 60, 'normal'))
    time.sleep(3)
...
def page2():
    ...
    turtle.color('blue')
    turtle.pendown()
    turtle.write('小春儿  慧哥哥', font=('wisdom', 50, 'normal'))
    turtle.penup()
    turtle.goto(-10, -190)
    draw_heart(11)
...
def main():
    turtle.setup(width=900, height=600, startx=300, starty=100)
    turtle.title("春儿的神秘礼物")
    page0()
    turtle.clear()
    page1()
    turtle.clear()
